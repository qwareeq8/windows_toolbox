...
def _resource_path(relative_path: str) -> str:
    ...
    In frozen (PyInstaller) mode, resolves relative to sys._MEIPASS.
    In dev mode, resolves relative to this file's directory.

    This is an inline copy of main.resource_path() to avoid a circular
    import (main.py imports webview.py, so webview.py cannot import main.py).
    """
